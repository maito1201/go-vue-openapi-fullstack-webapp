...
import (
	...
	"github.com/maito1201/go-vue-openapi-fullstack-webapp/server"
)

//go:generate swagger generate server --target ..\..\gen --name Factory --spec ..\..\..\swagger.yaml --api-package factory --principal interface{}
